...
import ingredients
from .views import create_ingredient, ingredient_interactions_by_id, get_all_ingredients

API_VERSION = f"{ingredients.API_VERSION}"

urlpatterns = [
    path(API_VERSION + "/ingredients/", create_ingredient, name="create_ingredient"),
    path(API_VERSION + "/ingredients/all/", get_all_ingredients, name="get_all_ingredients"),
    path(
